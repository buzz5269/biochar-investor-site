...
export default async function handler(req, res) {
  ...
  try {
    ...
    const subject = "Buswell Biochar — Contact Request";
    const html = `<p><b>Contact request</b></p><p><b>Name:</b> ${name}<br/><b>Email:</b> ${email}<br/><b>Company:</b> ${company || '-'}<br/><b>Message:</b><br/>${message.replace(/\n/g,'<br/>')}</p>`;
